...
adslotDiv.id = 'root'
document.body.insertBefore(adslotDiv, document.body.firstChild);

loadScriptTag("https://imasdk.googleapis.com/js/sdkloader/ima3.js")
loadScriptTag("https://cdn.jsdelivr.net/gh/rishabhtechcrumb/things-to-host@master/reactfastima/player2.js", () => {
    TC_YAAS.setup("root");
})
